...
C++ 规定 short 和 int 至少16位，long 至少32位，long long 至少64位。 带符号类型能够表示正数、负数和 0 ，而无符号类型只能够表示大于等于 0 的数。
...
32
4294967264
// in our machine, think unsigned 0 = 4294967296 after taking modulo operation
32
-32
0
0
...
```cpp
cpp.cc:6:35: error: expected ';' after struct
struct Foo { /* 此处为空  */ } // 注意：没有分号
```
